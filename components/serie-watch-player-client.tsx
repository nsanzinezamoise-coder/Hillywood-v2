...
const SerieWatchPlayer = dynamic(
    () => import("@/components/serie-watch-player").then((m) => ({ default: m.SerieWatchPlayer })),
    {
        ssr: false,
        loading: () => (
...
export function SerieWatchPlayerClient({ series }: { series: Series }) {
