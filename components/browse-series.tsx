...
export function BrowseSeries({ categories }: BrowseSeriesProps) {
  ...
  }, [hasMore, isLoading, isLoadingMore, page, fetchSeries])
      ...
      >
        {isLoadingMore && (
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-xs text-muted-foreground">Loading more series...</p>
          </div>
        )}
      </div>
